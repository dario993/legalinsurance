...
function initEventi(){
    ...
    $('#inputNascita').keyup(function(){
        formStatus.inputNascita =  $(this).val();
    });

    
    $('#selectAssicurazione').change(function (){
       formStatus.idSelectAssicurazione = $('#selectAssicurazione option:selected').val(); 
    });
